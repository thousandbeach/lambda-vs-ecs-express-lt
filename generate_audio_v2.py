...
SCRIPTS = [
    ...
    # SLIDE 9 - まとめ
    "2026年の、処方箋。一つ目。ラムダを、本業に戻せ。SQS、S3、イベントブリッジ、ウェブフック、クロン。ここで、ラムダは最強や。二つ目。APIサーバーには、コンテナ。制約なしのクラウドラン、AWS縛りなら、ついに対抗が来たECSエクスプレス。三つ目。1つの技術で全部やるな。ハイブリッドが正解。BFFはバーセル、APIはクラウドランかECSエクスプレス、イベントはラムダ、DB直結はエッジファンクションズ。適材適所。それだけの話や。ありがとうございました。",
]
